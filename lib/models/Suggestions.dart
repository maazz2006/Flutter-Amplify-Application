...
class Suggestions extends Model {
  static const classType = const _SuggestionsModelType();
  final String id;
  ...
  SuggestionsModelIdentifier get modelIdentifier {
      return SuggestionsModelIdentifier(
        id: id
      );
  }
  ...
  const Suggestions._internal({required this.id, required resturantName, required specials, required address, required lat, required long, required imageUrl, createdAt, updatedAt}): _resturantName = resturantName, _specials = specials, _address = address, _lat = lat, _long = long, _imageUrl = imageUrl, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Suggestions({String? id, required String resturantName, required String specials, required String address, required String lat, required String long, required String imageUrl}) {
    return Suggestions._internal(
  ...
  Suggestions copyWith({String? resturantName, String? specials, String? address, String? lat, String? long, String? imageUrl}) {
    return Suggestions._internal(
      id: id,
  ...
  static final QueryModelIdentifier<SuggestionsModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<SuggestionsModelIdentifier>();
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "Suggestions";
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: Suggestions.RESTURANTNAME,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: Suggestions.SPECIALS,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
...
class _SuggestionsModelType extends ModelType<Suggestions> {
  const _SuggestionsModelType();
  
  @override
  Suggestions fromJson(Map<String, dynamic> jsonData) {
    return Suggestions.fromJson(jsonData);
  }
}

/**
 * This is an auto generated class representing the model identifier
 * of [Suggestions] in your schema.
 */
@immutable
class SuggestionsModelIdentifier implements ModelIdentifier<Suggestions> {
  final String id;

  /** Create an instance of SuggestionsModelIdentifier using [id] the primary key. */
  const SuggestionsModelIdentifier({
    required this.id});
  ...
  @override
  String toString() => 'SuggestionsModelIdentifier(id: $id)';
  ...
  bool operator ==(Object other) {
    ...
    return other is SuggestionsModelIdentifier &&
      id == other.id;
  }
